...
dna_fn = float(matrix[1][0]) + float(matrix[2][0]) + float(matrix[3][0])
dna_fp = float(matrix[0][1]) + float(matrix[0][2]) + float(matrix[0][3])
dna_tn = float(matrix[1][1]) + float(matrix[1][2]) + float(matrix[1][3]) + float(matrix[2][1]) + float(matrix[2][2]) + float(matrix[2][3]) + float(matrix[3][1]) + float(matrix[3][2]) + float(matrix[3][3])
print("\nDNA -> TP: {} TN: {} FP: {} FN: {}".format(dna_tp, dna_tn, dna_fp, dna_fn))

rna_tp = float(matrix[1][1])
rna_fn = float(matrix[0][1]) + float(matrix[2][1]) + float(matrix[3][1])
rna_fp = float(matrix[1][0]) + float(matrix[1][2]) + float(matrix[1][3])
rna_tn = float(matrix[0][0]) + float(matrix[0][2]) + float(matrix[0][3]) + float(matrix[2][0]) + float(matrix[2][2]) + float(matrix[2][3]) + float(matrix[3][0]) + float(matrix[3][2]) + float(matrix[3][3])
print("RNA -> TP: {} TN: {} FP: {} FN: {}".format(rna_tp, rna_tn, rna_fp, rna_fn))

drna_tp = float(matrix[2][2])
drna_fn = float(matrix[0][2]) + float(matrix[1][2]) + float(matrix[3][2])
drna_fp = float(matrix[2][0]) + float(matrix[2][1]) + float(matrix[2][3])
drna_tn = float(matrix[0][0]) + float(matrix[0][1]) + float(matrix[0][3]) + float(matrix[1][0]) + float(matrix[1][1]) + float(matrix[1][3]) + float(matrix[3][0]) + float(matrix[3][1]) + float(matrix[3][3])
print("DRNA -> TP: {} TN: {} FP: {} FN: {}".format(drna_tp, drna_tn, drna_fp, drna_fn))

non_tp = float(matrix[3][3])
non_fn = float(matrix[0][3]) + float(matrix[1][3]) + float(matrix[2][3])
non_fp = float(matrix[3][0]) + float(matrix[3][1]) + float(matrix[3][2])
non_tn = float(matrix[0][0]) + float(matrix[0][1]) + float(matrix[0][2]) + float(matrix[1][0]) + float(matrix[1][1]) + float(matrix[1][2]) + float(matrix[2][0]) + float(matrix[2][1]) + float(matrix[2][2])
